...
class PdfReportConfig(BaseModel):
    ...
    # PDF filename: "<label>-<suffix>.pdf". The label is read from this Airtable
    # field and slugified; falls back to "report" when unset or empty.
    filename_label_field: str = ""
    filename_suffix: str = "Report"
